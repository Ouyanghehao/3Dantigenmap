...
print(f"✅ 绘制 new 序列：{len(new_indices)} 个金色点（已居中）")
...
print(f"\n🎉 完美完成！new序列已100%居中，图片已保存为 3D_map_perfect_centered.png")
